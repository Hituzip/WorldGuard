...
public class FailedLoadRegionSet extends AbstractRegionSet {
    ...
    private final String denyMessage = "Данные о регионе для WorldGuard не удалось загрузить для этого мира, поэтому " +
            "все было защищено в качестве меры предосторожности. Пожалуйста, сообщите об этом администратору сервера.";
